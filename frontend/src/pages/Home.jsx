            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  ...
                  cum illo repellendus veritatis repudiandae optio tenetur aut
                  similique nam, deserunt cumque. Iste enim sed qui fugit nisi
                  fugiat molestiae praesentium.
                </p>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">
                  3. View our physician who are accepting new patient.
                </li>
              </ul>
              <Link to={"/"}>
            ...
            <div className="relative z-10 xl:w[470px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="w-[65px] lg:w-[9px] bg-[#CCF0F3 py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full">
                  consultation
                </div>
                <div className="flex items-center gap-6 lg:gap-[10px] mt-2 lg:mt-[18px]">
                  <img src={avtarIcon} />
